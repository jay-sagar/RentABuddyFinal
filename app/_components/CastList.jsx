...
function CastList({ castList, heading='Popular Cast' }) {
  return (
              ...
              >
                ...
                <div className="mt-3 items-baseline flex flex-col gap-1">
                  ...
                  <h2 className="text-primary text-sm">
                    {item.attributes.Age} years old
                  </h2>
                  <h2 className="text-gray-500 text-sm">
                    {item.attributes.CostPerHour}/ per hour
                  </h2>
                  <Link href={'/details/'+item?.id} className="w-full">
                  <h2
                    className="p-2 px-3 border-[1px] border-primary text-primary rounded-full
                w-full text-center text-[11px] mt-2 cursor-pointer hover:bg-primary hover:text-white"
                  >
                    Book Now
                  </h2>
                  </Link>
